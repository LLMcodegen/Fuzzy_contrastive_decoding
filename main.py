...
def parse_args():
    ...
    parser.add_argument("--mean_num",type=float, default=0.0035)
    parser.add_argument("--filter_num",type=float, default=1/3)
    parser.add_argument("--num_beams",type=int, default=1)
    parser.add_argument('--src_weights', nargs='+', type=float, help='List of float values')
    parser.add_argument(
        "--model",
    ...
    parser.add_argument(
        "--use_constrast_decode",
        action="store_false",
        help="Use the token generated when running constrast decode.",
    )
    parser.add_argument(
        "--use_prompt_neg",
        type=int,
    ...
    parser.add_argument(
        ...
        type=int,
        default=1024,
        help="Maximum token length of new generated sequence",
    )
    parser.add_argument(
        "--precision",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default="fuzzy",
        help="Should the Fuzzy System Be Used?",
    )
    parser.add_argument(
        "--load_data_path",
        type=str,
    ...
    parser.add_argument(
        "--metric_output_path",
        type=str,
        default="/mnt/data/users/wangshuai/bigcode_contrast_decode/result_output/evaluation_results.json",
    ...
    parser.add_argument(
        ...
        type=str,
        default="/mnt/data/users/wangshuai/bigcode_contrast_decode/result_output/generations.json",
...
def main():
    ...
    print('--------------------------------')
    print("mean_num:", args.mean_num)
    print("filter_num:", args.filter_num)
    print("use_auth_token:", args.use_auth_token)
    print("num_beams:", args.num_beams)
    print("uncertain:", args.uncertain)
    print("src_weights:", args.src_weights)
    print("model:", args.model)
    print("tasks:", args.tasks)
    print("temperature:", args.temperature)
    print("n_samples:", args.n_samples)
    print("top_p:", args.top_p)
    print("allow_code_execution:", args.allow_code_execution)
    print("metric_output_path:", args.metric_output_path)
    print("save_generations:", args.save_generations)
    print("save_generations_path:", args.save_generations_path)
    print('--------------------------------')
